...
const signupProfileSchema = mongoose.Schema({
	lastName ://
	{
		type : String,
		required: true,
...
signupProfileSchema.pre('save', async function (next) {
...
signupProfileSchema.methods.generateAuthToken = async function() {
...
const modelSignupProfile = mongoose.model('signup-profile', signupProfileSchema, 'signup-profile');
